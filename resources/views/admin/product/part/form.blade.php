...
<div class="form-group">
    <input type="text" class="form-control" name="slug" placeholder="Наименование (на англ.)"
           required maxlength="100" value="{{ old('slug') ?? $product->slug ?? '' }}">
</div>

<div class="form-group">
    <!-- ціна (грн) -->
    <input type="text" class="form-control w-25 d-inline mr-4" placeholder="Цена (грн)"
